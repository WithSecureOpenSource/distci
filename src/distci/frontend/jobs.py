...
from distci.frontend import validators, request, response, jobs_builds, jobs_tags, distlocks, constants
...
class Jobs(object):
    ...
    def create_or_update_job(self, environ, start_response, job_id_param = None):
        ...
        try:
            ...
            return response.send_error(start_response, 400, constants.ERROR_JOB_INVALID_PAYLOAD)
    ...
    def get_job_config(self, start_response, job_id):
        ...
        for _ in range(10):
            try:
                ...
                time.sleep(0.1)
        if not job_data:
            return response.send_error(start_response, 409, constants.ERROR_JOB_LOCKED)
